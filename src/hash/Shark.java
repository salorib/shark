...
for (int j = 0; j < 32; j++) {
     ...
     */
    public static String[] toBinary(int[] ascii) {
     ...
     * @return String array
     */
    public static String[] toEightBits(String[] binary) {
    ...
    /**
     * Receibe an String array extract the length and returns the join of sub strings into array as an String
     * @param array
     * @return String
     */
    public static String joinAndApendOne(String[] array) {
     ...
     * @return String
     */
    public static String appendOne(String binary) {
        return binary += "1";
    }
     ...
     * @return 
     */
    public static String padAndAppendx64(String arraybinary) {
     ...
     * @return 
     */
    public static String untilx64(String binary) {
     ...
     * @return 
     */
    public static int[] toArrayInt(String binary) {
    ...
    /**
     * Extends matrix form 16 to 80 and fills with the original text on binary consecutivaly
     * @param matrix16
     * @return 
     */
    public static int[][] extendToEighty(int[][] matrix16) {
    ...
    public static String toHash(int[] c) {
        int n = 1;
        int dec = 0;
        for (int i = 0; i < 32; i++) {
            n = (int) pow(2, i);
